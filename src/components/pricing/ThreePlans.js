...
const Plan = styled.div`
  ...
  ${(props) =>
    ...
    css`
      background: #eb8ea1;
      background: linear-gradient(135deg, #eb8ea1 0%, #ee4c6c 100%);
background: #eb8ea1;
background: linear-gradient(135deg, #eb8ea1 0%, #ee4c6c 100%);
background: #eb8ea1;
background: linear-gradient(135deg, #eb8ea1 0%, #ee4c6c 100%);
      ${tw`bg-encarte text-gray-100`}
      .planHighlight {
        ${tw`hidden`}
      }
      .duration {
      ...
      ${BuyNowButton} {
        ${tw`bg-gray-100 text-encarte hocus:bg-gray-300 hocus:text-encarte`}
    `}
`;
...
export default ({
  ...
  const highlightGradientsCss = [
    css`
      background: #ed6884;
      background: linear-gradient(115deg, #ed6884 0%, #ed2f57 100%);
    `,
    css`
      background: #ed6884;
